...
Advantages
\begin{itemize}
    \item Makes learning and inference more efficient  % because we have less data
    \item Can improve generalization performance  % because we can avoid/limit the effects of the curse of dimensionality
