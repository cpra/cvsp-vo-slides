...
Stereo matching in Python using OpenCV % code is from the example that comes with OpenCV, check it out for details
...
\begin{itemize}
    \item Kinect SDK (\url{http://microsoft.com/en-us/kinectforwindows/}) % v1,v2, windows only
    \item OpenNI2 (\url{https://github.com/occipital/openni2}) % v1
    \item libfreenect2 (\url{https://github.com/OpenKinect/libfreenect2}) % v2
\end{itemize}
