...
\begin{center}
    \copyrightbox[b]
    {\includegraphics[width=6cm]{figures/local-feature-matching.jpg}}
...
\begin{center}
    \copyrightbox[b]
    {\includegraphics[width=7cm]{figures/panorama-stitching.jpg}} % stitching is not the typical example, but it can be regarded as one
...
Idea is to represent an image as a collection of \emph{visual words} % this comes from document retrieval - a text consists of words, an image of visual words
\begin{itemize}
